...
from mesh2cad.domain.types import Confidence, FeatureKind, HoleSectionKind, HoleTermination
...
@dataclass(slots=True)
class HoleSection:
    kind: HoleSectionKind = HoleSectionKind.CYLINDER
...
@dataclass(slots=True)
class HoleStackFeature(Feature):
